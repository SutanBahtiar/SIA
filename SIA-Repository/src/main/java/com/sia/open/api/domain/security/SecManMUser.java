...
public class SecManMUser extends BaseCreatedChanged<String> implements UserDetails {
    ...
    @Id
    @GenericGenerator(name = "seq_id_user", strategy = "com.sia.open.api.generator.UserIdGenerator")
