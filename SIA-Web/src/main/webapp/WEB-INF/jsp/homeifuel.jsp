...
<head>
    ...
    <title id="page-title">I-FUEL Management System</title>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB7XAj1U8ZEF8pu3qsT7HzAks8TYDYQhCE&sensor=false">
    </script>
...
<div id="loading">
    <div class="loading-indicator">
        <table>
            <tr>
                <td><img src="<c:url value="/resources/img/logo2.png"/>" alt="loading"/></td>
                <td>
