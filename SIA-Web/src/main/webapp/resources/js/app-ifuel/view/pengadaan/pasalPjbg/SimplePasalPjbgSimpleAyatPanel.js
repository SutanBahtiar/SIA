Ext.define('Ifuel.view.pengadaan.pasalPjbg.SimplePasalPjbgSimpleAyatPanel', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.simplePasalPjbgSimpleAyatPanel',
    title: 'Data Pasal',
    ...
    initComponent: function () {
        ...
        Ext.apply(this, {
            items: [
                Ext.create('Ifuel.view.pengadaan.pasalPjbg.SimplePasalPjbgGridPanel',
                    {
                        flex: 1,
    ...
    panelActivate:function(panel){
        var selecteds = panel.down("simplePasalPjbgGridPanel").getSelectionModel().getSelection();
        if(selecteds[0]){
    ...
    pasalGridSelectionChange: function (model, selected) {
        var me = this.up("simplePasalPjbgSimpleAyatPanel");
        if (selected[0]) {
