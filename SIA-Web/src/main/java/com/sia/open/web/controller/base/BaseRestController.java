...
import com.sia.open.api.domain.Base;
...
public abstract class BaseRestController<D extends Base, K extends Serializable, R extends PagingAndSortingRepository<D, K>> extends BaseExceptionHandler {
    ...
    public Class<D> getBaseClass() {
        return baseClass;
    }

    public void setBaseClass(Class<D> baseClass) {
        this.baseClass = baseClass;
    }

    protected Authentication getAuthenticationRequest() {
